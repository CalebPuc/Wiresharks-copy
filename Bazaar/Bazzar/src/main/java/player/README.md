...
The strategy components for a Bazaar player. The referee and common
packages should never import from here -- the referee only cares about
the result of a turn decision, not how it was computed.
...
means the player mechanism in M6 can swap strategies without changing anything else.
...
is how it compares two candidates. Should probably be refactored at some point
